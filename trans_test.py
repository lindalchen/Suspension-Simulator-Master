...
def getLateralForce(fitFunc, slipangle, camber, normalforce):
    ...
    for x in normalForces:
        ...
        lateralForces.append(cf*x)
    
    import matplotlib.pyplot as plt
    plt.plot(normalForces, lateralForces)
    plt.title('Lateral Force vs. Normal Force')
...
fitFunc = getFittingFunction('/Users/Max/Desktop/Personal/School/Princeton/PRE/Suspension-Dynamics-Simulator-master/TireFit/lateral_tire_fitting_function.csv')
constants = getConstants('suspension_points_2019_opt1.csv')
...
curves = kinematics_test.main(3, .05)
